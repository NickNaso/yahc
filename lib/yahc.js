...
module.exports = {
     ...
     * @param {number} [options.ntries = 1] This parameter represent the number
     * of attempts before to consider the request as failed.
    ...
    * GET({
        ...
        if (!url) {
            throw new RestClientError("Sorry rest client encountered an error" +
                " in executing request. Url parameter in GET request cannot" +
                " be null.");
        }
    ...
    * PUT({
        ...
        if (!url) {
            throw new RestClientError("Sorry rest client encountered an error in" +
                " executing request. Url parameter in PUT request cannot be null.");
        }
        try {
            // Init request options
            let requestOpts = {

...
/**
 * @description This function check if the file resource is expressed as string,
 * Buffer or Readable stream and return true or false respectively.
 * @param {Buffer | Readable} resource Represent the resource file to send to 
 * the server.
 * @return {boolean} boolean Return true if the resource is a Buffer orReadable
 * stream.
 * @private
 */
...
/**
 * @description This function check if the resource onject is expressed in a 
 * good way.
 * @param {object} resource Represent the resource file to send to the server
 * @return {boolean} boolean Return true if the resource object has the 
            ...
            if (encType === this.ENC_TYPES.X_WWW_FORM_URLENCODED && isJson) {
                ...
                if (files.length === 0) {
                    throw new RestClientError("Sorry rest client encountered" +
                        ...
                        " to multipart/form-data the files parameters in POST" +

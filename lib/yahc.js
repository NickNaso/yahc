        ...
        try {
            ...
            if (encType === this.ENC_TYPES.X_WWW_FORM_URLENCODED && isJson) {
                ...
                for (let resource of files) {
                    if (typeof resource === "string" || Buffer.isBuffer(resource) || resource instanceof Readable) {
                        filesToUpload.push(resource);
                    } else if (_.isObject(resource) && (!_.isEmpty(resource)) && _.has(resource, 'name') && _.has(resource, 'file')) {
